        ...
        @foreach ($all_appointments as $appointment)
            <div
                ...
                <p class=" flex flex-row  {{ session('theme_mode') == 'light' ? 'text-black' : 'text-white' }}">
                    <b>Name: &nbsp;</b>{{ $appointment['name'] }}</p>

                <p class=" flex flex-row  {{ session('theme_mode') == 'light' ? 'text-black' : 'text-white' }}">
                    <b>Email: &nbsp;</b>{{ $appointment['email'] }}</p>

                <p class=" flex flex-row  {{ session('theme_mode') == 'light' ? 'text-black' : 'text-white' }}">
                    <b>Phone: &nbsp;</b>{{ $appointment['contact_number'] }}</p>

                <p class=" flex flex-row  {{ session('theme_mode') == 'light' ? 'text-black' : 'text-white' }}">
                    <b>Address: &nbsp;</b>{{ $appointment['address'] ? $appointment['address'] : 'Not Available' }}</p>

                <p class=" flex flex-row  {{ session('theme_mode') == 'light' ? 'text-black' : 'text-white' }}">
                    <b>Description: &nbsp;</b>{{ $appointment['written_need'] }}</p>
