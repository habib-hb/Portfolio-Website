                ...
                <div class="flex flex-col justify-center items-center gap-y-2 py-[24px]">
                    ...
                    <div class="hs-tooltip [--placement:right] inline-block">
                        <a class="hs-tooltip-toggle size-[38px] inline-flex justify-center items-center gap-x-2 text-sm font-semibold rounded-full border border-transparent disabled:opacity-50 disabled:pointer-events-none"
                            ...
                            <img src="{{ asset('images/site-configuration.png') }}" class="h-[36px] rounded-lg bg-white p-1"
                                alt="">
                            <span
                    ...
                    <div class="hs-tooltip [--placement:right] inline-block">
                        <a class="hs-tooltip-toggle size-[38px] inline-flex justify-center items-center gap-x-2 text-sm font-semibold rounded-full border border-transparent disabled:opacity-50 disabled:pointer-events-none"
                            ...
                            <img src="{{ asset('images/appointments.png') }}" class="h-[36px] rounded-lg bg-white p-1"
                                alt="">
                            <span
                                class="hs-tooltip-content hs-tooltip-shown:opacity-100 hs-tooltip-shown:visible opacity-0 inline-block absolute invisible z-20 py-1.5 px-2.5 {{ session('theme_mode') == 'light' ? 'bg-[#1e1d1d] text-white' : 'bg-white text-black' }} text-xs  rounded-lg whitespace-nowrap "
                                role="tooltip">
                    ...
                    <div class="hs-tooltip [--placement:right] inline-block">
                        <a class="hs-tooltip-toggle size-[38px] inline-flex justify-center items-center gap-x-2 text-sm font-semibold rounded-full border border-transparent disabled:opacity-50 disabled:pointer-events-none"
                            ...
                            <img src="{{ asset('images/blogs.png') }}" class="h-[36px] rounded-lg bg-white p-1" alt="">
                            <span
                                class="hs-tooltip-content hs-tooltip-shown:opacity-100 hs-tooltip-shown:visible opacity-0 inline-block absolute invisible z-20 py-1.5 px-2.5 {{ session('theme_mode') == 'light' ? 'bg-[#1e1d1d] text-white' : 'bg-white text-black' }} text-xs  rounded-lg whitespace-nowrap "
                                role="tooltip">
                                Write Blogs
                    ...
                    <div class="hs-tooltip [--placement:right] inline-block">
                        <a class="hs-tooltip-toggle size-[38px] inline-flex justify-center items-center gap-x-2 text-sm font-semibold rounded-full border border-transparent disabled:opacity-50 disabled:pointer-events-none"
                            href="/admin_dashboard/blogs/blogs_manage">
                            <img src="{{ asset('images/manage-blogs.png') }}" class="h-[36px] rounded-lg bg-white p-1" alt="">
                            <span
                                class="hs-tooltip-content hs-tooltip-shown:opacity-100 hs-tooltip-shown:visible opacity-0 inline-block absolute invisible z-20 py-1.5 px-2.5 {{ session('theme_mode') == 'light' ? 'bg-[#1e1d1d] text-white' : 'bg-white text-black' }} text-xs  rounded-lg whitespace-nowrap "
                                role="tooltip">
                                Manage Blogs
                    ...
                    <div class="hs-tooltip [--placement:right] inline-block">
                        <a class="hs-tooltip-toggle size-[38px] inline-flex justify-center items-center gap-x-2 text-sm font-semibold rounded-full border border-transparent disabled:opacity-50 disabled:pointer-events-none"
                            ...
                            <img src="{{ asset('images/schedules-management.png') }}" class="h-[36px] rounded-lg bg-white p-1"
                                alt="">
                            <span
                                class="hs-tooltip-content hs-tooltip-shown:opacity-100 hs-tooltip-shown:visible opacity-0 inline-block absolute invisible z-20 py-1.5 px-2.5 {{ session('theme_mode') == 'light' ? 'bg-[#1e1d1d] text-white' : 'bg-white text-black' }} text-xs  rounded-lg whitespace-nowrap "
                                role="tooltip">
                    ...
                    <div class="hs-tooltip [--placement:right] inline-block">
                        <a class="hs-tooltip-toggle size-[38px] inline-flex justify-center items-center gap-x-2 text-sm font-semibold rounded-full border border-transparent disabled:opacity-50 disabled:pointer-events-none"
                            ...
                            <img src="{{ asset('images/explore-section-management.png') }}" class="h-[36px] rounded-lg bg-white p-1"
                                alt="">
                            <span
                                class="hs-tooltip-content hs-tooltip-shown:opacity-100 hs-tooltip-shown:visible opacity-0 inline-block absolute invisible z-20 py-1.5 px-2.5 {{ session('theme_mode') == 'light' ? 'bg-[#1e1d1d] text-white' : 'bg-white text-black' }} text-xs rounded-lg whitespace-nowrap"
                                role="tooltip">
                    ...
                    <div class="hs-tooltip [--placement:right] inline-block">
                        <a class="hs-tooltip-toggle size-[38px] inline-flex justify-center items-center gap-x-2 text-sm font-semibold rounded-full border border-transparent disabled:opacity-50 disabled:pointer-events-none"
                            ...
                            <img src="{{ asset('images/portfolio-section-management.png') }}" class="h-[36px] rounded-lg bg-white p-1"
                                alt="">
                            <span
                                class="hs-tooltip-content hs-tooltip-shown:opacity-100 hs-tooltip-shown:visible opacity-0 inline-block absolute invisible z-20 py-1.5 px-2.5 {{ session('theme_mode') == 'light' ? 'bg-[#1e1d1d] text-white' : 'bg-white text-black' }} text-xs rounded-lg whitespace-nowrap"
                                role="tooltip">
                    ...
                    <div class="hs-tooltip [--placement:right] inline-block">
                        <a class="hs-tooltip-toggle size-[38px] inline-flex justify-center items-center gap-x-2 text-sm font-semibold rounded-full border border-transparent disabled:opacity-50 disabled:pointer-events-none"
                            ...
                            <img src="{{ asset('images/price-estimator-management.png') }}"
                                class="h-[36px] rounded-lg bg-white p-1" alt="">
                            <span
                                class="hs-tooltip-content hs-tooltip-shown:opacity-100 hs-tooltip-shown:visible opacity-0 inline-block absolute invisible z-20 py-1.5 px-2.5 {{ session('theme_mode') == 'light' ? 'bg-[#1e1d1d] text-white' : 'bg-white text-black' }} text-xs rounded-lg whitespace-nowrap"
                                role="tooltip">
                                Price Estimator Management
                    ...
                    <div class="hs-tooltip [--placement:right] inline-block">
                        <a class="hs-tooltip-toggle size-[38px] inline-flex justify-center items-center gap-x-2 text-sm font-semibold rounded-full border border-transparent disabled:opacity-50 disabled:pointer-events-none"
                            ...
                            <img src="{{ asset('images/contact-messages.png') }}" class="h-[36px] rounded-lg bg-white p-1"
                                alt="">
                            <span
                                class="hs-tooltip-content hs-tooltip-shown:opacity-100 hs-tooltip-shown:visible opacity-0 inline-block absolute invisible z-20 py-1.5 px-2.5 {{ session('theme_mode') == 'light' ? 'bg-[#1e1d1d] text-white' : 'bg-white text-black' }} text-xs rounded-lg whitespace-nowrap"
                                role="tooltip">
                    ...
                    <div class="hs-tooltip [--placement:right] inline-block">
                        <a class="hs-tooltip-toggle size-[38px] inline-flex justify-center items-center gap-x-2 text-sm font-semibold rounded-full border border-transparent disabled:opacity-50 disabled:pointer-events-none"
                            ...
                            <img src="{{ asset('images/static-page-management.png') }}" class="h-[36px] rounded-lg bg-white p-1"
                                alt="">
                            <span
                                class="hs-tooltip-content hs-tooltip-shown:opacity-100 hs-tooltip-shown:visible opacity-0 inline-block absolute invisible z-20 py-1.5 px-2.5 {{ session('theme_mode') == 'light' ? 'bg-[#1e1d1d] text-white' : 'bg-white text-black' }} text-xs rounded-lg whitespace-nowrap"
                                role="tooltip">
                    ...
                    <div class="hs-tooltip [--placement:right] inline-block">
                        <a class="hs-tooltip-toggle size-[38px] inline-flex justify-center items-center gap-x-2 text-sm font-semibold rounded-full border border-transparent disabled:opacity-50 disabled:pointer-events-none"
                            ...
                            <img src="{{ asset('images/collaboration-section-management.png') }}" class="h-[36px] rounded-lg bg-white p-1"
                                alt="">
                            <span
                                class="hs-tooltip-content hs-tooltip-shown:opacity-100 hs-tooltip-shown:visible opacity-0 inline-block absolute invisible z-20 py-1.5 px-2.5 {{ session('theme_mode') == 'light' ? 'bg-[#1e1d1d] text-white' : 'bg-white text-black' }} text-xs rounded-lg whitespace-nowrap"
                                role="tooltip">
                    ...
                    <div class="hs-tooltip [--placement:right] inline-block">
                        <a class="hs-tooltip-toggle size-[38px] inline-flex justify-center items-center gap-x-2 text-sm font-semibold rounded-full border border-transparent disabled:opacity-50 disabled:pointer-events-none"
                            ...
                            <img src="{{ asset('images/testimonials-section-management.png') }}" class="h-[36px] rounded-lg bg-white p-1"
                                alt="">
                            <span
                                class="hs-tooltip-content hs-tooltip-shown:opacity-100 hs-tooltip-shown:visible opacity-0 inline-block absolute invisible z-20 py-1.5 px-2.5 {{ session('theme_mode') == 'light' ? 'bg-[#1e1d1d] text-white' : 'bg-white text-black' }} text-xs rounded-lg whitespace-nowrap"
                                role="tooltip">
