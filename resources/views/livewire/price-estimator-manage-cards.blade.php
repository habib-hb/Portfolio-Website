<div class="flex flex-col w-full m-0 p-0 min-h-[100vh] {{ session('theme_mode') == 'light' ? 'bg-[#EFF9FF]' : 'bg-[#090909]' }}"
    ...
    <main id="add_new_estimator" class="flex flex-col min-h-screen w-[96vw]  md:max-w-[800px] mx-auto">
        ...
        <div class="flex flex-col mt-2">
            ...
            <label for="title"
                class="opacity-80 {{ session('theme_mode') == 'light' ? 'text-black' : 'text-white' }}">Card
                Title</label>
        ...
        <div class="flex flex-col mt-2 mb-6">
            ...
            <label for="item_image"
                class="opacity-80 {{ session('theme_mode') == 'light' ? 'text-black' : 'text-white' }}">Card Thumbnail
        ...
        <label class="opacity-80 {{ session('theme_mode') == 'light' ? 'text-black' : 'text-white' }}">Card
            Description</label>
        ...
        <script>
            ...
            document.addEventListener('livewire:initialized', function() {
                ...
                Livewire.on('editable-estimator-card-area', (data) => {

                    setTimeout(() => {

                        quill.clipboard.dangerouslyPasteHTML(data.estimator_data);

                        window.location.href = '#add_new_estimator';
        ...
        <div
            ...
            <button wire:click="created_portfolios"
                ...
                Cards <img src="{{ asset('images/press_down.png') }}"
